 ...
 */
function _tests_load_woo_prod_support() {
	define( 'WOO_PROD_SUPPORT_DIRECTORY_PATH', trailingslashit( dirname( dirname( __FILE__ ) ) ) );
	require WOO_PROD_SUPPORT_DIRECTORY_PATH . 'woocommerce-product-support.php';
}
tests_add_filter( 'muplugins_loaded', '_tests_load_woo_prod_support' );
